...
func CancelCoupons(c *gin.Context) {
...
// @Accept json
// @Produce json
// @Param couponcode body ApplyCouponRequest true "Coupon code to apply to the cart"
// @Success 200 {json} ApplyCouponResponse "Coupon applied successfully"
// @Failure 400 {json} ErrorResponse "Error in applying the coupon"
